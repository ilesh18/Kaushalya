    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: '48px', justifyContent: 'space-between', position: 'relative', zIndex: 1 }}>
      <div style={{ maxWidth: '380px', flex: '1 1 300px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
          ...
          <strong style={{ fontSize: '1.6rem', fontFamily: "'Outfit', sans-serif", background: 'linear-gradient(135deg, var(--text-primary), var(--accent-purple))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>AbilityConnect</strong>
        </div>
      ...
      <div style={{ flex: '1 1 160px' }}>
        <nav aria-label="Platform links" style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <Link to="/about" aria-label="About AbilityConnect" style={{ transition: 'color 0.2s', opacity: 0.8 }}>About Us</Link>
          <Link to="/contact" aria-label="Contact AbilityConnect support" style={{ transition: 'color 0.2s', opacity: 0.8 }}>Contact</Link>
      ...
      <div style={{ flex: '1 1 140px' }}>
        <nav aria-label="Social media links" style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="Follow AbilityConnect on LinkedIn (opens in new tab)" style={{ display: 'flex', alignItems: 'center', gap: '8px', opacity: 0.8 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            LinkedIn <span className="sr-only">(opens in new tab)</span>
          </a>
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Follow AbilityConnect on Twitter (opens in new tab)" style={{ display: 'flex', alignItems: 'center', gap: '8px', opacity: 0.8 }}>
          ...
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Follow AbilityConnect on Instagram (opens in new tab)" style={{ display: 'flex', alignItems: 'center', gap: '8px', opacity: 0.8 }}>
